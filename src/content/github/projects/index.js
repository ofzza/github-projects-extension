...
// ============================================================================================
{
  ...
  initAugmentFiltering = function () {
    ...
    searchBarHelpPanelEl.style.right = '2px';
    searchBarHelpPanelEl.style.padding = '4px';
    ...
    searchBarHelpPanelEl.innerHTML = 'Enter any text and only issues and notes with matching Title, Number, Creator, Assignee or Label will be shown. <br/>\n' 
                                   + '<br /> \n'
